...
export default async function Home() {
    return (
        <main>
            ...
            <h1 className="text-3xl font-bold text-center mt-28">Imprint</h1>

            <div className="flex flex-col items-center gap-28 pb-20 mt-64">
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                     className="bg-foreground text-background w-80 h-fit overflow-hidden"
